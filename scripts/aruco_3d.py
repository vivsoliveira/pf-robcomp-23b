...
class Aruco3d:
    def __init__(self):
            ...
            self.camera_matrix   = np.loadtxt('/home/borg/catkin_ws/src/23b-robcomp-pf-vivsoliveira/pf-robcomp-23b/scripts/config/cameraMatrix_realsense.txt', delimiter=',')
            self.camera_distortion   = np.loadtxt('/home/borg/catkin_ws/src/23b-robcomp-pf-vivsoliveira/pf-robcomp-23b/scripts/config/cameraDistortion_realsense.txt', delimiter=',')
